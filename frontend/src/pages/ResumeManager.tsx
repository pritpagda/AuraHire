...
const ResumeManager: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-50 dark:bg-gray-900 text-slate-900 dark:text-white">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        {resumes.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 p-12 text-center rounded-xl shadow border dark:border-gray-700">
            <div className="w-20 h-20 mx-auto flex items-center justify-center bg-slate-100 dark:bg-gray-700 rounded-full mb-6">
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow border dark:border-gray-700">
              ...
              <div className="relative">
                ...
                >
                  {resumes.map(({ _id, filename, created_at }) => (
                    <option key={_id} value={_id}>
                      {filename} (Uploaded: {new Date(created_at).toLocaleDateString()})
                    </option>
                  ))}
                </select>
                <div className="absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none text-gray-700 dark:text-gray-300">
            ...
            {selectedResume ? (
              <ResumeCard resume={selectedResume} />
            ) : (
              <div className="bg-white dark:bg-gray-800 p-12 text-center rounded-xl shadow border dark:border-gray-700 text-slate-600 dark:text-slate-400">
